...
import { LogIn, Target, Dumbbell } from "lucide-react";
...
export default function HabitApp() {
  ...
  if (!user) return (
    <div className="flex flex-col items-center justify-center min-h-screen px-8 py-12 bg-[#090b10] text-white text-center">
      ...
      <h1 className="text-3xl font-black mb-2 tracking-tight">Habits Solo</h1>
      <p className="text-dim text-sm mb-12 max-w-xs">Fokus auf deine Routinen.</p>
