    ...
    <div className="card space-y-4">
       <div className="flex items-center justify-between">
          ...
          <button onClick={() => setHasActivity(!hasActivity)} 
            className={`px-3 py-1.5 rounded-lg text-[10px] font-bold border transition-all ${hasActivity ? 'border-orange bg-orange/10 text-orange' : 'border-line bg-bg2 text-dim hover:border-accent/30 hover:text-accent'}`}>
