          ...
          { (todaySession?.exercises?.length > 0 || todaySession?.activity) ? (
            <div className="card mb-0 border-accent/20 shadow-lg shadow-accent/5">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => onOpenSession?.()} className="w-12 h-12 rounded-2xl bg-accent flex items-center justify-center text-black shadow-lg shadow-accent/20 transition-transform active:scale-90">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-2">
                {recent.filter(s => s.date !== today).slice(0, 3).map(s => {
                  ...
                  return (
                    <button key={s.date} onClick={() => onOpenSession?.(s.date)}
