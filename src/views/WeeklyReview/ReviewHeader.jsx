  ...
  return (
    <section className="p-8 rounded-[32px] shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden bg-gradient-to-br from-card to-bg2 border border-fit-line">
      ...
      <div className="flex items-center gap-4 relative z-10">
        <button
          onClick={onExport}
          className="p-4 rounded-2xl bg-fit-accent/10 text-fit-accent border border-fit-accent/20 hover:bg-accent/20 transition-all flex items-center gap-2 text-[10px] font-black uppercase tracking-widest"
        >
          <Download size={14} /> Obsidian
        </button>

        <div className="flex items-center gap-2 bg-black/40 p-2 rounded-2xl border border-fit-line/50 shadow-inner">
          <input
            value={week}
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] bg-fit-accent text-black transition-transform active:scale-95 shadow-lg shadow-accent/20"
          >
            Aktuell
          </button>
        </div>
