...
import { Dumbbell, Award, Flame, Activity, Sparkles, RefreshCw, Layers } from 'lucide-react';
...
export default function ReviewStrengthMatrix() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div className="md:col-span-8 card p-8 bg-gradient-to-br from-fit-card via-fit-bg2 to-fit-card border border-fit-line shadow-xl relative overflow-hidden flex flex-col justify-center">
          <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
            <Dumbbell size={180} className="text-fit-accent" />
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black tracking-tight text-fit-ink">Stärke-Matrix</h2>
              <p className="text-fit-dim text-[11px] font-semibold">1RM-Prognosen &amp; RPE Target Zones</p>
            </div>
          </div>
        </div>
