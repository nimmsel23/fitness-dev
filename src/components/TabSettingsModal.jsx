...
export default function TabSettingsModal({ title, onClose, children }) {
  return (
    <div className="fixed inset-0 z-[150] flex items-end sm:items-center justify-center p-4 animate-in fade-in duration-200">
      ...
      <div className="relative w-full max-w-sm bg-fit-card border border-fit-line rounded-[32px] shadow-2xl animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-200">
