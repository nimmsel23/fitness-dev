...
from .history import log_training_entry, progress_hint, read_history
...
from .preview import cleanup_preview_file, preview_file, write_preview_file
from .resolver import build_exercise_index, candidate_texts, normalize_text, resolve_query
from .teaching import teach_exercise, find_lesson
from .weekly import build_weekly_coverage
from .wger import build_plan_wger_payload, get_wger_mapping, map_wger, wger_check
