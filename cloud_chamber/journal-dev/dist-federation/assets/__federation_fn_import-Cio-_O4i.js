...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BN8Au471.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'lucide-react':{get:()=>()=>__federation_import(new URL('__federation_shared_lucide-react-DDI_G934.js', import.meta.url).href),import:true}};
