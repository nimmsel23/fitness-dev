const currentImports = {};
      ...
      let moduleMap = {
"./JournalApp":()=>{
      dynamicLoadingCss([], false, './JournalApp');
      return __federation_import('./__federation_expose_JournalApp-BOVfGZgP.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__journal__' + exposeItemName;
