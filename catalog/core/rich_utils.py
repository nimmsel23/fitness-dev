...
if TYPE_CHECKING:
    from catalog.core.audit import AuditBundle, AuditReport, ExerciseAuditResult
    from catalog.bootstrap import BootstrapEvent
    from catalog.core.doctor import DoctorReport
