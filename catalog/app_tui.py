...
from catalog.history import log_training_entry, progress_hint, read_history
...
from catalog.preview import cleanup_preview_file, preview_file, write_preview_file
from catalog.core.resolver import build_exercise_index, candidate_texts, normalize_text, resolve_query
from catalog.agent.teaching import teach_exercise, find_lesson
from catalog.weekly import build_weekly_coverage
from catalog.core.wger import build_plan_wger_payload, get_wger_mapping, map_wger, wger_check
