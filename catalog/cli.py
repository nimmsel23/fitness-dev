...
from catalog.core.paths import DATA_DIR
from catalog.bootstrap import bootstrap as run_bootstrap
from catalog.core.audit import (
    run_anatomy_audit,
    run_coverage_audit,
    run_aliases_audit,
    audit_exercises,
...
from catalog.coverage import calculate_coverage as run_calculate_coverage
from catalog.core.doctor import run_doctor
from catalog.history import ensure_history_db, log_training_entry as run_log_training_entry, progress_hint, read_history
from catalog.agent.obsidian import (
...
from catalog.preview import preview_file, render_markdown
from catalog.planner import build_plan
from catalog.agent.teaching import teach_exercise
from catalog.core.wger import build_plan_wger_payload, map_wger as run_map_wger, wger_check
from catalog.core.wger_index import export_wger_index as run_export_wger_index
from catalog.core.resolver import resolve_query
from catalog.weekly import build_weekly_coverage
from catalog.tui import run_tui
from catalog.api.watcher import run_watcher
from catalog.importer import import_external_exercises
from catalog.api.firestore_push import run_kb_sync, push_changed_exercises
from catalog.core.rich_utils import (
    console,
    print_audit_report,
...
def alias_add(
    ...
    from catalog.api.watcher import load_gemini_key
    ...
    if aliases:
        ...
        from catalog.agent.gemini import load_gemini_key, suggest_aliases, suggest_aliases_cli
