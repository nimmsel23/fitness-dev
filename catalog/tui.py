...
def screen_dashboard() -> str:
    ...
    try:
        from catalog.core.resolver import build_exercise_index
...
def screen_browser() -> str:
    ...
    try:
        from catalog.core.resolver import build_exercise_index, candidate_texts, normalize_text
        idx = build_exercise_index()
...
def screen_lesson() -> str:
    ...
    try:
        ...
        from catalog.preview import render_markdown
